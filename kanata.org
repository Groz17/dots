...
m (tap-hold 175 175 m (tap-hold-press-timeout 0 230 m m (macro S-m)))
...
(deflayer c-c-prefix
  _
  _ _ _ _ _ _ _ _ _ _ _ _ _ _
  _ (macro C-c q) (macro C-c w) (macro C-c e) (macro C-c r) (macro C-c t) (macro C-c y) (macro C-c u) (macro C-c i) (macro C-c o) (macro C-c p) _ _
  _ (macro C-c a) (macro C-c s) (macro C-c d) (macro C-c f) (macro C-c g) (macro C-c h) (macro C-c j) (macro C-c k) (macro C-c l) (macro C-c ;) _ _ _
  _ _ (macro C-c z) (macro C-c x) _ (macro C-c v) (macro C-c b) (macro C-c n) (macro C-c m) _ _ _ _
  _ _ _ _ _ _ _ _
  _ _ _
)
#+end_src
...
(deflayer c-c-x-prefix
  _
  _ _ _ _ _ _ _ _ _ _ _ _ _ _
  _ (macro C-c C-x q) (macro C-c C-x w) (macro C-c C-x e) (macro C-c C-x r) (macro C-c C-x t) (macro C-c C-x y) (macro C-c C-x u) (macro C-c C-x i) (macro C-c C-x o) (macro C-c C-x p) _ _
  _ (macro C-c C-x a) (macro C-c C-x s) (macro C-c C-x d) (macro C-c C-x f) (macro C-c C-x g) (macro C-c C-x h) (macro C-c C-x j) (macro C-c C-x k) (macro C-c C-x l) (macro C-c C-x ;) _ _ _
  _ _ (macro C-c C-x z) (macro C-c C-x x) (macro C-c C-x c) (macro C-c C-x v) (macro C-c C-x b) (macro C-c C-x n) (macro C-c C-x m) _ _ _ _
  _ _ _ _ _ _ _ _
  _ _ _
)
#+end_src
...
(deflayer left-ctrl-layer
  _
  _ _ _ _ _ _ _ _ _ _ _ _ _ _
  _ (macro C-q) (macro C-w) (macro C-e) (macro C-r) (macro C-t) (macro C-y) (macro C-u) (macro C-i) (macro C-o) (macro C-p) _ _
  _ (macro C-a) (macro C-c C-x) (macro C-d) (macro C-f) (macro C-g) (macro C-h) (macro C-j) (macro C-k) (macro C-l) _ _ _ _
  _ _ (macro C-z) (macro C-x) (layer-while-held c-c-prefix) (macro C-v) (macro C-b) (macro C-n) (macro C-m) _ _ _ _
  _ _ _ _ _ _ _ _
  _ _ _
)
#+end_src
...
(deflayer right-ctrl-layer
  ...
  _ _ _ _ _ _ _ _ _ _ _ _ _ _
  _ (macro C-q) (macro C-w) (macro C-e) (macro C-r) (macro C-t) (macro C-y) (macro C-u) (macro C-i) (macro C-o) (macro C-p) _ _
  _ (macro C-a) (macro C-s) (macro C-d) (macro C-f) (macro C-g) (macro C-h) (macro C-j) (macro C-k) (macro C-c C-x) _ _ _ _
  _ _ (macro C-z) (macro C-x) (layer-while-held c-c-prefix) (macro C-v) (macro C-b) (macro C-n) (macro C-m) _ _ _ _
  _ _ _ _ _ _ _ _
  _ _ _
)

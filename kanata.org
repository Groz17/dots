...
(defalias
  ...
  ccx-d (tap-hold-press-timeout 175 175 (macro C-c C-x d) (macro C-c C-x d) (macro C-c C-x S-d))
  ...
  ccx-k (tap-hold-press-timeout 175 175 (macro C-c C-x k) (macro C-c C-x k) (macro C-c C-x S-k))
...
(deflayer c-c-x-prefix
  _
  _ _ _ _ _ _ _ _ _ _ _ _ _ _
  _ @ccx-q @ccx-w @ccx-e @ccx-r @ccx-t @ccx-y @ccx-u @ccx-i @ccx-o @ccx-p _ _
  _ @ccx-a @ccx-s @ccx-d @ccx-f @ccx-g @ccx-h @ccx-j @ccx-k @ccx-l @ccx-; _ _ _
  _ _ @ccx-z @ccx-x @ccx-c @ccx-v @ccx-b @ccx-n @ccx-m _ _ _ _
  _ _ _ _ _ _ _ _
  _ _ _
)
#+end_src

...
#+begin_src kbd
(defalias
  ;; Samsung TV remote control via a local pipe consumer.
  ;; Each action appends one JSON command line to /tmp/tvpipe.
...
(deflayer TV
  ...
  _        _ _ _         _ _ @tv-left @tv-voldown @tv-volup @tv-right   _         _ _ _

...
(deflayer c-c-prefix
  _
  _ _ _ _ _ _ _ _ _ _ _ _ _ _
  _ (macro C-c q) (macro C-c w) (macro C-c e) (macro C-c r) (macro C-c t) (macro C-c y) (macro C-c u) (macro C-c i) (macro C-c o) (macro C-c p) (macro C-c [) (macro C-c ])
  _ (macro C-c a) (macro C-c s) (macro C-c d) (macro C-c f) (macro C-c g) (macro C-c h) (macro C-c j) (macro C-c k) (macro C-c l) (macro C-c ;) (macro C-c ') (macro C-c \) _
  _ _ (macro C-c z) (macro C-c x) _ (macro C-c v) (macro C-c b) (macro C-c n) (macro C-c m) (macro C-c ,) (macro C-c .) (macro C-c /) _
  _ _ _ _ _ _ _ _
  _ _ _
)
#+end_src

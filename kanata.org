...
#+begin_src kbd
(defalias
;; Basic mouse movements (interval=1ms, distance=1px)
msu (movemouse-up 1 1)
msd (movemouse-down 1 1)
msl (movemouse-left 1 1)
msr (movemouse-right 1 1)

;; Accelerated mouse movements (interval=1ms, accel-time=1000ms, min=1px, max=5px)
...
_ _ _ _     _ _ _ @msl @msd @msu @msr _ _ _ _
_ _ _ _     _ _ _ mlft mmid mrgt @mwd _ _
_ _ _ _     _ _ _ _
_ _ _
)
#+end_src
...
#+begin_src kbd
(a caps)  (cmd bash -c "WAYLAND_DISPLAY=$WAYLAND_DISPLAY; wtype à") 100 first-release ()
(a ')  (cmd bash -c "WAYLAND_DISPLAY=$WAYLAND_DISPLAY; wtype á") 100 first-release ()

(e caps)  (cmd bash -c "WAYLAND_DISPLAY=$WAYLAND_DISPLAY; wtype è") 200 first-release ()
(e ')  (cmd bash -c "WAYLAND_DISPLAY=$WAYLAND_DISPLAY; wtype é") 100 first-release ()

(i caps)  (cmd bash -c "WAYLAND_DISPLAY=$WAYLAND_DISPLAY; wtype ì") 100 first-release ()
(i ')  (cmd bash -c "WAYLAND_DISPLAY=$WAYLAND_DISPLAY; wtype í") 100 first-release ()

(o caps)  (cmd bash -c "WAYLAND_DISPLAY=$WAYLAND_DISPLAY; wtype ò") 100 first-release ()
(o ')  (cmd bash -c "WAYLAND_DISPLAY=$WAYLAND_DISPLAY; wtype ó") 100 first-release ()

(u caps)  (cmd bash -c "WAYLAND_DISPLAY=$WAYLAND_DISPLAY; wtype ù") 100 first-release ()
(u ')  (cmd bash -c "WAYLAND_DISPLAY=$WAYLAND_DISPLAY; wtype ú") 100 first-release ()
)
#+end_src

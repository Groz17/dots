...
m (tap-hold 175 175 m (tap-hold-press-timeout 0 230 m (layer-while-held mouse) (macro S-m)))
c (tap-hold 175 175 c (tap-hold-press-timeout 0 230 c (layer-while-held mouse) (macro S-c)))
#+end_src

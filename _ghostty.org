...
#+begin_src conf
# TODO: non funge con ssh/neovim/emacs/adb cwd
...
** General
#+begin_src conf
keybind=super+alt+slash=start_search
# keybind=super+alt+0=toggle_background_opacity
# same mapping as neovim's :restart?
keybind=super+alt+shift+r=reload_config
keybind = super+alt+a=select_all
keybind = ctrl+shift+c=copy_to_clipboard
keybind = super+alt+y=copy_url_to_clipboard
...
# pipe: block mnemonic
# keybind = super+alt+shift+pipe=toggle_readonly
...
keybind = super+alt+r=activate_key_table:resize
#+end_src
...
keybind = super+alt+1=toggle_split_zoom
keybind = super+alt+shift+t=toggle_tab_overview

...
#+begin_src zsh
# git clone it?
# git clone --depth=1 https://github.com/mattmc3/antidote.git /home/giorgio/.config/zsh/.antidote
...
*** List
#+begin_src text :tangle ~/.config/zsh/.zsh_plugins.txt
...
# TODO: https://github.com/michel-kraemer/zsh-patina
...
# C-M-e - shell expand line (like readline: expands $vars, aliases, ~, etc.)
_shell_expand_line() {
  # First expand aliases
  [[ $LBUFFER =~ '(^|[;|&])\s*([A-Za-z_][A-Za-z0-9_-]*)$' ]] && LBUFFER=${LBUFFER%%${match[2]}}${aliases[${match[2]}]:-${match[2]}}
  # Then expand parameters, command substitutions, etc.
  LBUFFER="${${(e)LBUFFER}%%[[:space:]]##}"
  RBUFFER="${${(e)RBUFFER}##[[:space:]]##}"
}
zle -N _shell_expand_line
bindkey '^[^E' _shell_expand_line
...
zle -N copy-line-to-clipboard; copy-line-to-clipboard() { print -n -- "\e]52;c;$(print -rn -- "$BUFFER" | base64 -w0)\a" }
bindkey '\ew' copy-line-to-clipboard

zle -N copy-pwd-to-clipboard; copy-pwd-to-clipboard() { print -n -- "\e]52;c;$(print -rn -- "${PWD/#$HOME/~}" | base64 -w0)\a" }
bindkey '^Xp' copy-pwd-to-clipboard

zle -N exec-bash; exec-bash() { BUFFER='exec bash'; zle accept-line }
bindkey '^X^' exec-bash

zle -N ssh-<<alternate()>>; ssh-<<alternate()>>() { BUFFER='ssh <<alternate()>>'; zle accept-line }
bindkey '^Xs' ssh-<<alternate()>>
...
** Aliases
Crea alias per subcommands? tipo n s per notmuch search (o PR ambiguita)
#+begin_src zsh :noweb yes
<<sh|.org:aliases()>>
...
alias -g T="| tail"
alias -g G="| grep"
alias -g L="| awk '{print length(),\$0}' | sort -k 1n  | sed  's/[0-9]\+ //'"
# auto-identify stdin?
alias -g M="| pandoc -t commonmark "
alias -g S="| sort"
alias -g U="| sort -u"
alias -g Q="| qrencode -t ansiutf8"
alias -g V="--vimgrep | ifne nvim -q-"
alias -g W="| wc -l"
alias -g X="| xargs"
alias -g Y="| yank"
...
alias -s json=jq
# rg --type-list
# alias -s {a{c,d{b,oc,s},gda,idl,lire.toml,s{c{,iidoc,x},m,p{,x}},ts,utomount,v{dl,pr,sc},wk},b{a{sh{,rc},t,zel{,rc}},b{,append,class},ib,p,r,st,x{,m,s},zl},c{a{bal,rp,ts},bor,c,dxml,eylon,f{c,g,m},js,l{j{,c,s,x},s},m{ake,d,l},o{ffee,mposer.lock,nf{,ig{,.ru}}},pphs,r{,eole},s{,h{,rc,tml},proj,s,v},ts,u{,h}},d{a{rt,ts},e{f,vice},hall,i{d,ff,ta{,map,val}},pr,t{d,s{,i,o},x},vc},e{build,c{lass,r},dn,ex,js,l{,m},nv,p{p,s},r{b,l},x{,s}},f{bs,i{dl,sh},nl,s{,i,proj,x},ut},g{ap,d,emspec,i,leam,n{,i},o,pr,r{a{dle{,.properties,w{,.bat}},phql{,s}},oovy},vimrc,z},h{a{,ml,ts},bs,eex,h,pp,rl,s{,c},tm{,l},y},i{d{l,r},ly,n{c,i,l,s},pynb,rbrc},j{a{net,va},inja,l,pynb,s{,on{,l},p{,x},x}},k{sh{,rc},t{,s}},l{agda,e{an,ex,ss},hs,i{dr,nk,sp,vemd},l,o{ck,g{,in,out}},pr,sp,tx,ua,y,zma},m{a{k{,o},o,rkdown},d{,own,wn,x},e{diawiki,son.{build,options}},int,js,k{,d{,n},file},l{,i,l,y},m,o{,unt},ts},ni{m{,ble,f,s},x},org,p{a{s,t{ch,h}},df,erl,fo,h{p,t{,ml}},l{,h,x},m,o{,d},p,r{f,i,o{,file,j,log,p{erties,s},to}},s{,ql},urs,x{d,i},y{,i,x}},q{ml,rc},r{ak{e,u{,doc,mod,test}},b{,w},doc,e{,d{,s},i,s{,i}},kt,md,n{g,w},obot,s{,t}},s{a{rif,ss,ts},bt,c{,ala,d{,oc},h,m,ope,ss},ervice,h{,ard.yml},ig,kim,l{i{ce,m{,e}},n{,f}},ml,o{cket,l,y},p{ark,ec},ql,sa,ty{,l},v{,elte,g,h},w{ap,ift}},t{a{rget{,s},skpaper},c{l,sh{,rc}},e{rraform{.rc,rc},x{,i,tile}},f{,rc,vars},gz,hrift,imer,oml,pl,s{,t,x},wig,x{t,z},yp{,oscript}},u{i,sd{,a,c}},v{ala,b,c{l,xproj},g,h{,d{,l}},im{,rc},sh,ue},w{ebidl,gsl,i{dl,ki}},x{html,jb,ml,s{d,l{,t}},z},y{a{ml,ng},ml},z{ig,log{in,out},profile,s{h{,env,rc},t{,d}}}}=nvim
alias -s pdf=emacsclient -ca ''
#+end_src
